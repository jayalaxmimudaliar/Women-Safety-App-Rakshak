...
home extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sharedPreferences= getActivity().getSharedPreferences(loginIn.PREFS_NAME,0);
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                if(cycledays!= finalSharedPreferences.getString("cycledays", "")||periodlength!= finalSharedPreferences.getString("periodlength", "")){
...
// Set up the buttons
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    editor.commit();
                    cycledays = finalSharedPreferences1.getString("cycledays", "");
                }
            });
...
// Specify the type of input expected; this, for example, sets the input as a password, and will mask the text
            input.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_NORMAL);
            builder.setView(input);
            SharedPreferences finalSharedPreferences2 = sharedPreferences;
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    Log.i("Hi", "Hi");
                    ...
                    editor.commit();
                    periodlength = finalSharedPreferences2.getString("periodlength", "");
                }
            });
        ...
        if((!next_period_date.equals("")?Integer.parseInt(next_period_date) : 0) > 31){
            ...
            if((!save_day.equals("")?Integer.parseInt(save_day) : 0) > dayOfMonth){
                ...
                next_period_date = next_period_date + "/" + Integer.toString((!save_month.equals("")?Integer.parseInt(save_month) : 0) + 2) +"/" + save_year;
                tv3.setText("Next period is expected on " + next_period_date);
            }
        }
        Map<String, Object> newData = new HashMap<>();
        newData.put("Cycle_days",cycledays );
        newData.put("PeriodLength", periodlength);
        newData.put("SaveDay", save_day);
        newData.put("SaveMonth", save_month);
        newData.put("SaveYear", save_year);
            ...
            public void onDateSet(DatePicker view, int y, int m, int d) {
                ...
                if((!ovulation_date.equals("")?Integer.parseInt(ovulation_date) : 0) > 31){
                    ...
                    if((!save_day.equals("")?Integer.parseInt(save_day) : 0) > dayOfMonth){
                        ...
                        ovulation_date = ovulation_date + "/" + Integer.toString(((!save_month.equals("")?Integer.parseInt(save_month) : 0) + 1)%12) +"/" + save_year;
                        tv2.setText("Next ovulation is expected on " + ovulation_date);
                    }}
